...
// Validaciones //
const validacionesDetalle = [validacionesUser.validarSesion, validacionesPedido.validarCamposDetalle,
    validacionesPedido.validarPedidoExistente, validacionesPedido.validarPedidoDeUsuario, validacionesPedido.validarEstadoPedido,
    validacionesProducto.validarProductoExistente, validacionesProducto.validarProductoActivo];
const validacionesDelete = [validacionesUser.validarSesion, validacionesPedido.validarPedidoExistente, validacionesPedido.validarPedidoDeUsuario];
const validacionDelDetalle = [validacionesUser.validarSesion, validacionesPedido.validarPedidoExistente, validacionesPedido.validarPedidoDeUsuario,
...
const validacionesConfirmarPedido = [validacionesUser.validarSesion, validacionesPedido.validarPedidoExistente, validacionesPedido.validarPedidoDeUsuario,
    validacionesPedido.validarPedidoNuevo, validacionesPedido.validarProductosEnPedido];
const validacionesModifEstado = [validacionesUser.validarSesion, validacionesUser.validarAdmin, validacionesPedido.validarPedidoExistente,
    validacionesPedido.validarPedidoConfirmado, validacionesPedido.validarEstadoEnReq];
// RUTAS //
// Registro de nuevo pedido //
router.post('', validacionesUser.validarSesion, pedidoCtrl.pedidoAlta);
...
router.get('', [validacionesUser.validarSesion, validacionesUser.validarAdmin], pedidoCtrl.listarPedidos);
...
router.get('/historial-pedidos', [validacionesUser.validarSesion, validacionesPedido.validarPedidosDeUsuario], pedidoCtrl.listarPedidosDeUsuario);
...
router.put('/modificar-direccion', [validacionesPedido.validarPedidoExistente, validacionesPedido.validarPedidoDeUsuario], pedidoCtrl.cambiarDireccionEntrega);
